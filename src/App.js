                ...
                <div className="container pa">
                    ...
                    <div className="row">
                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                            <img src="./img/penguin.png" alt="" className="ar" />
                        </div>
            ...
            <footer>
                <div className="container">
                    ...
                    <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                            ...
                            <p className="text-white">View Verified Smart Contract: <br/><span className="pain_texts">r98Y09l45Be56W3462849Mdyf348Nf869504Q1</span> </p>
                        </div>
                        ...
                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                            ...
                            <div className="social_link ">
                                ...
                                <a href=""> <i className="fab fa-discord text-white"></i></a>
                                <a href=""> <i className="fas fa-ship text-white"></i></a>
                            </div>
                        </div>
